...
class TorusConv2d(nn.Module):
    def __init__(self, input_dim, output_dim, kernel_size, padding, bn):
        super().__init__()
        self.conv = nn.Conv2d(input_dim, output_dim, kernel_size=kernel_size, padding=padding, padding_mode='circular')
...
class GeeseNet(nn.Module):
    def __init__(self):
        ...
        self.conv0 = TorusConv2d(17, filters, (5, 5), 2, True)
        self.blocks = nn.ModuleList([TorusConv2d(filters, filters, (3, 3), 1, True) for _ in range(layers)])
